...
function Popup(){
    ...
    <div   className=" bg-gray-700 opacity-90 fixed inset-0 z-50 " >
                            <div className='flex h-screen relative w-auto justify-center items-center'> 
                                <div className="flex flex-col justify-center text-center bg-white py-12 px-24 border-4 rounded-xl ">
                                    
                                    <div className="font-bold text-2xl text-center ">Login to chat with seller</div>
